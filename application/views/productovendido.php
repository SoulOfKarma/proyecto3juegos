...
<div class="container">
  ...
  <?php foreach($arrJuego as $juego) { ?>
    <tr>
	  <th scope="row" style=" background-color:#252525 ; "><?php echo $juego->idventas ?></th>
      ...
      <td> <input type="submit" class="form-control btn-info" value="Ver Producto" onclick="ver('<?php echo $juego->nombre_producto ?>')"></td>
	  <?php } ?>
    </tr>
...
{ 
    ...
    form.method = 'post';
    form.action = "<?= base_url() ?>index.php/Cliente/voucher";
