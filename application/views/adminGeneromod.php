...
<div id="formulario_imagenes" class="form-control" style="background-color: #252525;">
	  ...
	  <form action="<?php echo base_url()?>index.php/Admin/crudModificarGenero" method="post">
  ...
  <?php foreach($arrGenero as $juego) { ?>
    <tr>
      ...
      <input type="hidden" name="idemp" id="idemp" value="<?php echo $juego->idgenero ?>">
      <td style="background-color: #252525;"><input type="text" name="modEmp" id="modEmp" value="<?php echo $juego->descripcion ?>"></td>
